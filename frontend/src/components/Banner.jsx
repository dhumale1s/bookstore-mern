            ...
            <div className="max-w-screen-2x1 container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
                <div className='order-2 md:order-1 w-full md:w-1/2 mt-12 md:mt-32'>
                    <div className='space-y-12'>
                        ...
                        <p className='text-x1'>
                            Lorem ipsum dolor sit amet. Non blanditiis quasi aut mollitia neque aut soluta itaque sit ratione autem quo animi asperiores eum nulla natus.
                        </p>
                ...
                <img src={banner} className='w-98 h-98' alt="" />
                </div>
            </div>
        </>
    )
